...
*/
//flags 0-6位
#define ZEROPAD 1  // 填充零 1
#define SIGN 2     // unsigned/signed long 10
#define PLUS 4     // 显示加 100
#define SPACE 8    // 如是加，则置空格 1000
#define LEFT 16    // 左调整 10000
#define SPECIAL 32 // 0x 100000
#define SMALL 64   // 使用小写字母 1000000
